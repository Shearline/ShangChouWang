...
<script type="text/javascript">
    ...
    function initPagination() {
        ...
        //声明一个SOM对象存储Pagination要设置的属性
        var properties = {
            num_edge_entries: 3,                                          //边缘页数
            num_display_entries: 5,                                       //主体页数
            callback: pageselectCallback,                                 //回调
            items_per_page: ${requestScope.pageInfo.pageSize},            //每页显示数据的数量
            current_page:${requestScope.pageInfo.pageNum - 1},            //当前页。Pagination内部使用pageIndex来管理页码，pageIndex从0开始，PageNum从1开始，所以要减一
            prev_text: "上一页",
            next_text: "下一页",
        }
        //生成页码导航条
